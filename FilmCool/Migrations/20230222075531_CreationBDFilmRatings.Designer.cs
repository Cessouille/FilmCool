...
namespace FilmCool.Migrations
{
    ...
    [Migration("20230222075531_CreationBDFilmRatings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmCool.Models.EntityFramework.Film", b =>
                {
            ...
            modelBuilder.Entity("FilmCool.Models.EntityFramework.Notation", b =>
                {
                    b.Property<int>("FilmId")
                        .HasColumnType("integer")
                        .HasColumnName("flm_id");
                    ...
                    b.ToTable("t_j_notation_not", t =>
                        {
                            t.HasCheckConstraint("ck_note", "not_note between 0 and 5");
                        });
                });

            modelBuilder.Entity("FilmCool.Models.EntityFramework.Utilisateur", b =>
                {
                    b.Property<int>("UtilisateurId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FilmCool.Models.EntityFramework.Notation", b =>
                {
                    b.HasOne("FilmCool.Models.EntityFramework.Film", "FilmNote")
                        .WithMany("NotesFilm")
                    ...
                    b.HasOne("FilmCool.Models.EntityFramework.Utilisateur", "UtilisateurNotant")
